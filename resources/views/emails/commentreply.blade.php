...
<body>
	...
	<div class="container">
		...
		<div class="_body" style="padding:1em 2em;">
		    ...
		    <h2 style="color:#ffffff; padding:0em 2em;">Your recent comment has a response.</h2>

		    <div style="text-align: left !important;">
		    	<b>{{ $comment_author }}</b>, I hope you are keeping well. The comment you left at my website has a new response by <b>{{ $response_author }}</b>. Please click below button to check out the response.
		    </div>

		    <br/><br/>

		    <a href="https://codewithkarani.tech/collections/{{$post_id}}/article" target="_blank" id="button">View Response in Site</a>
		...
		<div class="_body">
			<table>
				<tr>
					<td>
						<p>You are receiving this message because your comment at <a href="https://codewithkarani.tech">Code with Karani</a> has a response</p>
